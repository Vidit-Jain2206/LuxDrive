...
const Footer = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-4 p-5 bg-black text-white h-2/3 not-italic">
      {/* stay Connected */}
      ...
      <div className="flex flex-col mt-[3rem]">
        <h3 className="text-center uppercase ">Subscribe to our Newsletter</h3>
        <div className="">
          <div className="">
            <form action="" className="flex flex-col justify-center mt-5">
              <input
                type="email"
                placeholder="Enter your email"
                className="focus:outline-none border-[1px] border-white bg-transparent px-4 py-1 text-sm text-white rounded-lg "
              />
              <button
                type={"button"}
                className="bg-white font-semibold text-black text-sm  py-1 px-2 rounded-lg mt-1 active:bg-black active:text-white "
              >
                Join Us
              </button>
            </form>
      ...
      <p className="md:col-span-3 text-center text-sm mt-[2rem] ">
        © 2023 by Vidit Jain. Powered and secured by LuxDrive
      </p>
    </div>
  );
};
